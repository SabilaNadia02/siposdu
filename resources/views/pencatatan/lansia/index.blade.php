            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <p style="color: #777777; white-space: normal;">Halaman ini untuk mengelola data pencatatan pada Usia Produktif dan Lansia.</p>
                    </div>
                    <div class="col-sm-4">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        ...
                        <div class="small-box bg-white border border-warning link-dark">
                            <div class="inner">
                                <h3>0</h3>
                                <p>Total Pencatatan</p>
                            </div>
                            <a href="#"
                                class="small-box-footer bg-warning link-dark link-underline-opacity-0 link-underline-opacity-50-hover">
