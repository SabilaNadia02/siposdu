    ...
    <main class="app-main">
        <div class="app-content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-8">
                        <h3 class="mb-0" style="color: #333333;">Edit Data Obat</h3>
                        <p style="color: #777777;">Halaman ini digunakan untuk mengubah data obat posyandu.
                        </p>
                    </div>
                    <div class="col-sm-4">
                        <ol class="breadcrumb float-sm-end">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('data-master.obat.index') }}"
                                    style="color: #FF69B4; font-size: 16px;">Data Obat</a>
                            </li>
                    ...
                    <div class="col-md-8" style="border-radius: 0px">
                        <div class="card" style="border-top: 3px solid #FF69B4; border-radius: 0px">
                            <div class="card-body" style="border-radius: 0px">
                                <form action="{{ route('data-master.obat.update', $obat->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row g-3 mb-3" style="font-size: 14px;">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="nama"
                                                name="nama" value="{{ old('nama', $obat->nama) }}" required
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control form-control-sm" id="keterangan" name="keterangan" rows="3"
                                                placeholder="Masukkan Keterangan" style="font-size: 14px;">{{ old('keterangan', $obat->keterangan) }}</textarea>
                                        </div>
                                    </div>
