...
<div class="modal fade" id="tambahSkriningModal" tabindex="-1" aria-labelledby="tambahSkriningModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" style="position: absolute; right: 30%; top: 25%; transform: translateY(-50%);">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('data-master.skrining.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        <!-- Nama Skrining -->
                        <div class="col-md-12">
                            <label for="nama_skrining" class="form-label" style="font-size: 14px; margin-bottom: 2px;">Nama Skrining</label>
