    ...
    <main class="app-main">
        ...
        <div class="app-content-header">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0" style="color: #333333;">Data Vaksin</h3>
                        <p style="color: #777777;">Halaman ini untuk mengelola data vaksin.</p>
                    </div>
                    <div class="col-sm-6">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @forelse($dataVaksin as $key => $vaksin)
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">
                                                    <!-- Tombol Edit -->
                                                    <a href="{{ route('data-master.vaksin.edit', $vaksin->id) }}"
                                                    ...
                                                    <!-- Tombol Hapus -->
                                                    <form
                                                        action="{{ route('data-master.vaksin.destroy', $vaksin->id) }}"
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4" class="text-center text-muted">Tidak ada data vaksin.
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
