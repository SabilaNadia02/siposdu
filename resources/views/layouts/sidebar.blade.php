...
<aside class="app-sidebar bg-white shadow" data-bs-theme="light">
    ...
    <div class="sidebar-brand">
        <a href="{{ url('/') }}" class="brand-link d-flex align-items-center text-dark text-decoration-none">
        ...
        <nav class="mt-2">
            <ul class="nav flex-column sidebar-menu" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                @if (auth()->user()->role == 1 || auth()->user()->role == 2)
                    <li class="nav-item has-treeview {{ Request::is('pemberian/*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ url('/pemberian/imunisasi') }}"
                ...
                @if (auth()->user()->role == 1 || auth()->user()->role == 2 || auth()->user()->role == 3)
                    ...
                    <li class="nav-item">
                        <a href="{{ url('kelulusan-balita') }}"
                            class="nav-link {{ Request::is('kelulusan-balita') ? 'active' : '' }}">
                ...
                @if (auth()->user()->role == 1 || auth()->user()->role == 2)
                    <li class="nav-item">
                        <a href="{{ url('/rujukan') }}" class="nav-link {{ Request::is('rujukan') ? 'active' : '' }}">
                ...
                @if (auth()->user()->role == 1)
                    ...
                    <li class="nav-item has-treeview {{ Request::is('data-master/*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ url('/data-master/vitamin') }}"
                            ...
                            <li class="nav-item">
                                <a href="{{ url('/data-master/skrining') }}"
                            ...
                            <li class="nav-item">
                                <a href="{{ url('/data-master/pertanyaan') }}"
                            ...
                            <li class="nav-item">
                                <a href="{{ url('/data-master/pertanyaan-skrining') }}"
                            ...
                            <li class="nav-item">
                                <a href="{{ url('/data-master/posyandu') }}"
                            ...
                            <li class="nav-item">
                                <a href="{{ url('/data-master/pengguna') }}"
