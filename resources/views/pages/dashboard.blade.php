...
@section('meta_description', 'AdminLTE Dashboard Page')
...
@section('title', 'Dashboard')
@section('meta_title', 'AdminLTE v4 | Dashboard')
@section('meta_description', 'Dashboard with Small Box Components')
@section('meta_keywords', 'dashboard, small box, adminlte')
