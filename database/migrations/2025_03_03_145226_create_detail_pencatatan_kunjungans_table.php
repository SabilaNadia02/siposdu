...
return new class extends Migration
{
    ...
    {
        Schema::create('detail_pencatatan_kunjungans', function (Blueprint $table) {
            $table->id();
            $table->foreignIdFor(PencatatanKunjungan::class, 'id_pencatatan_kunjungan')->nullable()->constrained()->nullOnDelete()->cascadeOnUpdate();
    ...
    {
        Schema::dropIfExists('detail_pencatatan_kunjungans');
    }
};
